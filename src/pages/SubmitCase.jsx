...
export default function SubmitCase() {
  ...
  const handlePrevious = () => {
    if (currentStep > 0) {
      ...
      // Skip grain de beauté questions if patient doesn't have them
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Créer le pharmacien
      const pharmacist = await base44.entities.Pharmacist.create({
      ...
      // Créer le dossier
      // Consolider toutes les réponses du questionnaire
      ...
      const caseRecord = await base44.entities.Case.create({
      ...
      try {
        await base44.functions.invoke('syncToHubspot', { caseId: caseRecord.id });
      } catch (hubspotError) {
        console.error('Erreur sync HubSpot:', hubspotError);
      }
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 shadow-xl">
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="consent" className="text-sm text-blue-900">
                    ...
                    J'atteste que le patient a été informé et a consenti au recueil et au traitement de ses données de santé dans le cadre de cette téléexpertise dermatologique. Le patient comprend que ses photos et informations cliniques seront transmises à un dermatologue qualifié pour obtenir un avis médical.
                  </Label>
                </div>
              </div>
            </div>
          ...
          {/* Step 10: Signes grains de beauté */}
          {currentStep === 10 && (
            <div className="space-y-6">
              <div>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                <div className="flex items-start gap-3">
                  ...
                  <Label htmlFor="privacy" className="text-sm text-blue-900">
                    ...
                    J'accepte que les données de santé collectées soient traitées par Tessan et transmises à un dermatologue qualifié dans le cadre de cette téléexpertise. Les données sont hébergées de manière sécurisée et conforme HDS. Durée de conservation: 12 mois.
                  </Label>
                </div>
              </div>
